...
const RECALL_DESCRIPTION =
  ...
  + "memory answers you: the first result is often not the right one.\n\n"
  ...
  + "that answers the question beats a broad summary that merely discusses the same topic.\n\n"
...
const REMEMBER_DESCRIPTION =
  ...
  + "second brain. Call this automatically whenever the user shares context, goals, decisions, or preferences "
  + "— capturing genuinely useful information is the point, so do not ask permission first.\n\n"
